...
class DHCPAndDNSClient:
    ...
    def start(self):
        ...
        dhcp_discover = sniff(filter="udp and (port 67 or 68)",timeout=5, iface=self.argument )
        ...
        dhcp_response = sniff(filter="udp and (port 67 or 68)", timeout=1, iface=self.argument )
